...
season    = Season.create(active: false, league_id: league.id)

# participants
mark_h       = Participant.create(first_name: "Mark", last_name: "Harris", user_id: user.id)
john_m       = Participant.create(first_name: "Jonathan", last_name: "Mann", user_id: user.id)
mark_m       = Participant.create(first_name: "Mark", last_name: "Miranda", user_id: user.id)
chris        = Participant.create(first_name: "Chris", last_name: "Kampe", user_id: user.id)
andy         = Participant.create(first_name: "Andy", last_name: "Baum", user_id: user.id)
mike         = Participant.create(first_name: "Michael", last_name: "Cassano", user_id: user.id)
mike_g       = Participant.create(first_name: "Mike", last_name: "Green", user_id: user.id)
tyler        = Participant.create(first_name: "Tyler", last_name: "Merry", user_id: user.id)
scott        = Participant.create(first_name: "Scott", last_name: "Lukes", user_id: user.id)
jesse        = Participant.create(first_name: "Jesse", last_name: "Mortenson", user_id: user.id)
eric         = Participant.create(first_name: "Eric", last_name: "Starling", user_id: user.id)
alan         = Participant.create(first_name: "Alan", last_name: "Schindler", user_id: user.id)
henry        = Participant.create(first_name: "Henry", last_name: "Desroches", user_id: user.id)
roman        = Participant.create(first_name: "Roman", last_name: "Gavrilov", user_id: user.id)
shawn        = Participant.create(first_name: "Shawn", last_name: "Lyndon", user_id: user.id)
bobby        = Participant.create(first_name: "Bobby", last_name: "Yang", user_id: user.id)
zach         = Participant.create(first_name: "Zach", last_name: "Moore", user_id: user.id)
jeremy       = Participant.create(first_name: "Jeremy", last_name: "Balu", user_id: user.id)
julius       = Participant.create(first_name: "Julius", last_name: "Bogdan", user_id: user.id)
